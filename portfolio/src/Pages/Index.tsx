...
const Index = () => {
    ...
    const themeBlack:string [] = ["Container_Home_Black", "Container_Sobre_Black", "Container_Curriculo_Black", "Container_Projetos_Black", "Container_Contato_Black"]

    const themeLight:string [] = ["Container_Home_Light","Container_Sobre_Light", "Container_Curriculo_Light", "Container_Projetos_Light", "Container_Contato_Light"]
...
<div className={`Container_Contato ${ themas?.theme != "light" ? themeLight[4] : themeBlack[4]} `}  id="contato"> <Contato/></div>
 </>
    )
}
