    ...
    return (
        <>
            ...
            <div className="ConfigProjeto_Container" id="landingPage"   >
                ...
                <p id="landingPage" className="paragrafodesc" >Página Landing Page q eu fiz como desafio da rocketSeat.</p>
            </div>
...
export default All_FrontEnd_Projects